...
const About = () => {
    return (
        <div className="mx-4 lg:mx-0 lg:mr-16 p-8 mt-4 rounded-lg shadow-lg bg-white dark:bg-gray-800 transition-colors duration-300" id="Home">
            <div className="mb-6">
            ...
            <div className="mt-6 text-md text-gray-700 dark:text-gray-300 text-justify">
            ...
            <div className="mt-6 mb-1">
                <h2 className="text-3xl font-semibold text-center text-gray-800 dark:text-white">What I do!</h2>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8 px-4">
                    <div className="bg-orange-100 dark:bg-orange-900/30 p-6 rounded-lg shadow-md transition-colors duration-300">
                        <h3 className="text-xl font-bold mb-2 flex items-center text-gray-800 dark:text-white">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-700 p-6 rounded-lg shadow-md transition-colors duration-300">
                        <h3 className="text-xl font-bold mb-2 flex items-center text-gray-800 dark:text-white">
