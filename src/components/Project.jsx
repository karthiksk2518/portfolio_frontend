...
//             <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4">Projects</h1>
//             <hr className="border-t-2 border-orange-500 w-20 mb-6" />
//             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
//                 {projects.map((project) => (
//                     <div
//                         key={project.id}
//                         className="relative group bg-gray-100 border-2 border-gray-200 rounded-lg shadow-md overflow-hidden"
//                     >
//                         <img
//                             src={project.image || "/placeholder.svg"}
//                             alt={project.name}
//                             className="w-full h-48 object-cover group-hover:blur-sm transition duration-500"
//                         />
//                         <div className="p-4">
