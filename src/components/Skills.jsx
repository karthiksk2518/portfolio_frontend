...
const Skills = () => {
    ...
    return (
        <div className="mx-4 lg:mx-0 lg:mr-16 mt-4 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md transition-colors duration-300" id="Skill">
            <div className="mb-6">
                <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-4">Skill</h1>
                <hr className="border-t-2 border-orange-500 w-20 mb-6" />
            </div>

            <div className="flex flex-col gap-8">
                <div className="text-gray-700 dark:text-gray-300 mb-4 p-8 rounded-md text-justify bg-orange-100 dark:bg-orange-900/30 transition-colors duration-300">
                    <p>
                ...
                <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-10 p-8 justify-items-center bg-gray-100 dark:bg-gray-700 rounded-md transition-colors duration-300">
                    {skills.map((skill, index) => (
                        ...
                        >
                            <div
                                className={`p-4 rounded-full bg-white dark:bg-gray-800 shadow-md transform transition-all duration-300 group-hover:scale-100 ${skill.color}`}
                            >
                                {skill.icon}
                            </div>
                            <span className="absolute bottom-14 text-sm font-medium text-gray-700 dark:text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                {skill.name}
                            </span>
                        </div>
                    ))}
