...
//             <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4">Contact</h1>
//             <hr className="border-t-2 border-orange-500 w-20 mb-6" />
...
//                     <span className="font-bold">new projects, opportunities in tech world, partnerships</span>.
//                 </p>
//                 <form onSubmit={handleSubmit}>
//                     <div className="mb-4">
